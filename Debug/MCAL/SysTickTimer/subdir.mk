...
C_SRCS += \
../MCAL/SysTickTimer/STK_program.c 

OBJS += \
./MCAL/SysTickTimer/STK_program.o 

C_DEPS += \
./MCAL/SysTickTimer/STK_program.d 


# Each subdirectory must supply rules for building sources it contributes
MCAL/SysTickTimer/%.o MCAL/SysTickTimer/%.su MCAL/SysTickTimer/%.cyclo: ../MCAL/SysTickTimer/%.c MCAL/SysTickTimer/subdir.mk
...
clean: clean-MCAL-2f-SysTickTimer

clean-MCAL-2f-SysTickTimer:
	-$(RM) ./MCAL/SysTickTimer/STK_program.cyclo ./MCAL/SysTickTimer/STK_program.d ./MCAL/SysTickTimer/STK_program.o ./MCAL/SysTickTimer/STK_program.su

.PHONY: clean-MCAL-2f-SysTickTimer
